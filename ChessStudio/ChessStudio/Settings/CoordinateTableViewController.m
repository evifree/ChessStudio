//
//  CoordinateTableViewController.m
//  ChessStudio
//
...
@interface CoordinateTableViewController () {
...
@implementation CoordinateTableViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = NSLocalizedString(@"COORDINATES", nil);
    
    contents = [UtilToView getTipoCoordinate];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[contents objectAtIndex:indexPath.row] isEqualToString:[settingManager coordinate]]) {
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row != checkedRow) {
        ...
        checkedRow = indexPath.row;
        [settingManager setCoordinate:[contents objectAtIndex:indexPath.row]];
        if (_delegate) {
            [_delegate updateFromCoordinate];
        }
    }
