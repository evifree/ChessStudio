//
//  BoardSizeTableViewController.m
//  ChessStudio
//
...
@interface BoardSizeTableViewController () {
...
@implementation BoardSizeTableViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = NSLocalizedString(@"BOARD_SIZE", nil);
    contents = [UtilToView getTipoBoardSize];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[contents objectAtIndex:indexPath.row] isEqualToString:[settingManager boardSizeAsString]]) {
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row != checkedRow) {
        ...
        checkedRow = indexPath.row;
        [settingManager setBoardSize:(int)indexPath.row];
        if (_delegate) {
            [_delegate updateFromBoardSize];
        }
    }
