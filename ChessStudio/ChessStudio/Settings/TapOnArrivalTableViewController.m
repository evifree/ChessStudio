//
//  TapOnArrivalTableViewController.m
//  ChessStudio
//
//  Created by Giordano Vicoli on 16/04/15.
...
@interface TapOnArrivalTableViewController () {
...
@implementation TapOnArrivalTableViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = NSLocalizedString(@"SETTINGS_TAP_ARRIVAL_SQUARE", nil);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        if (indexPath.row == 0) {
            ...
            cell.detailTextLabel.text = @"Tap Nella casa di arrivo";
            cell.imageView.image = nil;
            UISwitch *switchView = [[UISwitch alloc] initWithFrame:CGRectZero];
            //switchView.tag = 403;
            //[switchView addTarget:self action:@selector(updateSwitch:) forControlEvents:UIControlEventTouchUpInside];
            [switchView addTarget:self action:@selector(tapArrivoSwitched:) forControlEvents:UIControlEventValueChanged];
        ...
        if (indexPath.row == 0) {
            ...
            if ([[settingManager colorTapDestination] isEqualToString:NSLocalizedString(@"ORANGE", nil)]) {
            ...
            cell.imageView.image = nil;
            cell.accessoryView = nil;
            if ([[settingManager colorTapDestination] isEqualToString:NSLocalizedString(@"YELLOW", nil)]) {
                [cell setAccessoryType: UITableViewCellAccessoryCheckmark];
                colorCheckedRow = indexPath.row;
            }
            else {
            ...
            cell.imageView.image = nil;
            cell.accessoryView = nil;
            if ([[settingManager colorTapDestination] isEqualToString:NSLocalizedString(@"BLACK", nil)]) {
                [cell setAccessoryType: UITableViewCellAccessoryCheckmark];
                colorCheckedRow = indexPath.row;
            }
            else {
            ...
            cell.imageView.image = nil;
            cell.accessoryView = nil;
            if ([[settingManager colorTapDestination] isEqualToString:NSLocalizedString(@"WHITE", nil)]) {
                [cell setAccessoryType: UITableViewCellAccessoryCheckmark];
                colorCheckedRow = indexPath.row;
            }
            else {
            ...
            cell.imageView.image = nil;
            cell.accessoryView = nil;
            if ([[settingManager colorTapDestination] isEqualToString:NSLocalizedString(@"RED", nil)]) {
                [cell setAccessoryType: UITableViewCellAccessoryCheckmark];
                colorCheckedRow = indexPath.row;
            }
            else {
            ...
            cell.imageView.image = nil;
            cell.accessoryView = nil;
            if ([[settingManager colorTapDestination] isEqualToString:NSLocalizedString(@"GREEN", nil)]) {
                [cell setAccessoryType: UITableViewCellAccessoryCheckmark];
                colorCheckedRow = indexPath.row;
            }
            else {
            ...
            cell.imageView.image = nil;
            cell.accessoryView = nil;
            if ([[settingManager colorTapDestination] isEqualToString:NSLocalizedString(@"BLUE", nil)]) {
                [cell setAccessoryType: UITableViewCellAccessoryCheckmark];
                colorCheckedRow = indexPath.row;
            }
            else {
...
- (void) updateSwitch:(UISwitch *)switchView {
    if (switchView.tag == 403) {
        [settingManager setTapDestination:[switchView isOn]];
    }
}

- (void) tapArrivoSwitched:(UISwitch *)switchView {
    [settingManager setTapDestination:[switchView isOn]];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 1) {
        ...
        if (indexPath.row != colorCheckedRow) {
            ...
            [settingManager setColorTapDestination:selectedColor];
        }
    }
}
