//
//  PgnMentorEventsTableViewController.h
//  ChessStudio
//
...
@interface PgnMentorEventsTableViewController : UITableViewController<NSURLConnectionDelegate, NSURLConnectionDataDelegate, UIAlertViewDelegate, PgnMentorSaveDatabaseDelegate>
