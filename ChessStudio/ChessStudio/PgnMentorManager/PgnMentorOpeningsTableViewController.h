//
//  PgnMentorOpeningsTableViewController.h
//  ChessStudio
//
...
@interface PgnMentorOpeningsTableViewController : UITableViewController<NSURLConnectionDelegate, NSURLConnectionDataDelegate, UIAlertViewDelegate, PgnMentorSaveDatabaseDelegate>
