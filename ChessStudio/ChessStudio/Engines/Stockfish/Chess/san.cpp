...
Move move_from_san(Position &pos, const std::string &movestr) {
  ...
  // Castling moves
  if(movestr == "O-O-O" || movestr == "O-O-O+" || movestr == "O-O-O#" || movestr == "0-0-0" || movestr == "0-0-0+" || movestr == "0-0-0#") {
    Move m;
  ...
  else if(movestr == "O-O" || movestr == "O-O+" || movestr == "O-O#" || movestr == "0-0" || movestr == "0-0+" || movestr == "0-0#") {
    Move m;
    while((m = mp.get_next_move()) != MOVE_NONE)
