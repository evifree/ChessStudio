...
@protocol NalimovBoardViewControllerDelegate <NSObject>
...
@interface NalimovBoardViewController : UIViewController<PieceButtonDelegate, UIWebViewDelegate, BoardViewDelegate, UIGestureRecognizerDelegate, UIAlertViewDelegate, UIActionSheetDelegate, SettingsTableViewControllerDelegate, GameDetailTableViewControllerDelegate, AnnotationMoveTableViewControllerDelegate, MFMailComposeViewControllerDelegate, GameInfoTableViewControllerDelegate, SetupPositionViewDelegate, SideToMoveViewControllerDelegate, TextCommentViewControllerDelegate, EngineControllerDelegate, ADBannerViewDelegate, ControllerTableViewControllerDelegate, BoardViewControllerMenuDelegate, BoardViewPositionMenuDelegate, TextCommentPopoverViewControllerDelegate, DatabaseForCopyTableViewControllerDelegate, SelectionPieceViewDelegate, UITableViewDelegate, UITableViewDataSource, ControlNalimovViewDelegate, RNGridMenuDelegate>


@property (nonatomic, assign) id<NalimovBoardViewControllerDelegate> delegate;
